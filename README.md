...
**Frontend**
React · Next.js · Expo · React Native · Tailwind

**Backend**
Node.js · Supabase · Firebase · PostgreSQL

**Cloud**
Vercel · AWS · Railway · Digital Ocean

**Payments & Growth**
RevenueCat · Stripe · App Store Connect · Google Play

**AI**
OpenAI · Claude · LangChain · Multi-agent systems
